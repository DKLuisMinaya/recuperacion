        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          <!-- Add icons to the links using the .nav-icon class
               ...
               <li class="nav-item menu-is-opening menu-open">
                    ...
                    <li class="nav-item">
                    <a href="http://127.0.0.1:8000/indexCategoria" class="nav-link">
                    <i class="far fa-circle nav-icon" ></i>
                        <p>Categoria</p>
                    </a>
                    </li>
                    <li class="nav-item">
                    <a href="http://127.0.0.1:8000/indexProducto" class="nav-link active">
                    <i class="far fa-circle nav-icon"></i>
                    <p>Producto</p>
                    </a>
                    </li>
                    <li class="nav-item">
                    <a href="http://127.0.0.1:8000/datos" class="nav-link">
                    <i class="far fa-circle nav-icon"></i>
                    <p>Compra/Venta</p>
                    </a>
                    </li>
  ...
  <div class="content-wrapper">
       <section class="content">
            ...
            <form action="{{url('registro')}}" method="post">
                ...
                <label for="">Horas: </label><br><br>
                <input type="number" name="horas"><br><br>

                <label for="">Departamento: </label><br><br>
